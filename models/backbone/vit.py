...
def resize_pos_embed(posemb, posemb_new, hight, width, hw_ratio=1):
    ...
    if hw_ratio ==8:
        ...
        posemb = torch.cat([posemb_token, posemb_grid, posemb_grid, posemb_grid, posemb_grid, posemb_grid, posemb_grid, posemb_grid], dim=1)  ##, posemb_grid
    if hw_ratio == 2:
        posemb_token, posemb_grid = posemb[:, :1], posemb[:, 1:]
        posemb = torch.cat([posemb_token, posemb_grid, posemb_grid], dim=1)
