...
from models.backbone.resnets1 import resnet50_s1

# from .transformer_both import BothTransformer
# from .transformer_spa import SpaTransformer
# from .transformer_temp import TempTransformer
